<template>
  ...
  <v-container class="pb-14">
    ...
    <div v-if="filteredDays.length === 0 && liturgicalDays.length > 0" class="text-center mt-10 text-gray-500">
      Keine Ergebnisse für „{{ search }}"
    </div>

    <div v-if="liturgicalDays.length === 0" class="text-center mt-10 text-gray-500">
      Laden...
    </div>
  </v-container>
